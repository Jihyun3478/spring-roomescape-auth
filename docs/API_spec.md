...
- [x] 예외: 인증되지 않은 사용자가 로그아웃을 시도하는 경우 예외가 발생한다.
    - 상태 코드: 401
    - 예외 메시지: "로그인이 필요합니다."
...
- [x] 예외: 인증되지 않은 사용자가 예약을 추가하는 경우 예외가 발생한다.
    - 상태 코드: 401
    - 예외 메시지: "로그인이 필요합니다."
...
- [x] 예외: 인증되지 않은 사용자가 예약을 조회하는 경우 예외가 발생한다.
    - 상태 코드: 401
    - 예외 메시지: "로그인이 필요합니다."
...
- [x] 예외: 인증되지 않은 사용자가 예약을 변경하는 경우 예외가 발생한다.
    - 상태 코드: 401
    - 예외 메시지: "로그인이 필요합니다."
...
- [x] 예외: 인증되지 않은 사용자가 예약을 삭제하는 경우 예외가 발생한다.
    - 상태 코드: 401
    - 예외 메시지: "로그인이 필요합니다."
...
- [x] 예외: 인증되지 않은 사용자가 접근하는 경우 예외가 발생한다.
    - 상태 코드: 401
    - 예외 메시지: "로그인이 필요합니다."
