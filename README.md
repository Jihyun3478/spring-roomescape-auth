...
- [ ] 사용자가 로그인할 수 있다.
  - [ ] [예외] 이메일 또는 비밀번호가 올바르지 않은 경우, 401을 반환한다.
- [ ] 로그인한 사용자가 로그아웃할 수 있다.
- [ ] 인증이 필요한 API에 미인증 사용자가 접근하면 401을 반환한다.
...
- [ ] 예외: 이메일 또는 비밀번호가 올바르지 않은 경우 예외가 발생한다.
    - 상태 코드: 401
...
- [ ] 예외: 인증되지 않은 사용자가 로그아웃을 시도하는 경우 예외가 발생한다.
    - 상태 코드: 401
    - 예외 메시지: "로그인이 필요합니다."
...
- [ ] 예외: 인증되지 않은 사용자가 예약을 추가하는 경우 예외가 발생한다.
    - 상태 코드: 401
    - 예외 메시지: "로그인이 필요합니다."
- [x] 예외: 예약 날짜가 null인 경우, 400을 반환한다.
    - 상태 코드: 400
...
- [ ] 예외: 인증되지 않은 사용자가 예약을 조회하는 경우 예외가 발생한다.
    - 상태 코드: 401
    - 예외 메시지: "로그인이 필요합니다."
...
- [ ] 예외: 인증되지 않은 사용자가 예약을 변경하는 경우 예외가 발생한다.
    - 상태 코드: 401
    - 예외 메시지: "로그인이 필요합니다."
...
- [ ] 예외: 인증되지 않은 사용자가 예약을 삭제하는 경우 예외가 발생한다.
    - 상태 코드: 401
    - 예외 메시지: "로그인이 필요합니다."
